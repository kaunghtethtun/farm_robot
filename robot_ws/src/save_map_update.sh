...
LOCALIZATION_LAUNCH="/home/mr_robot/robot_ws/install/farmbot_carto/share/farmbot_carto/launch/localization.launch.py"
NAV2_PARAMS="/home/mr_robot/robot_ws/install/farmbot_nav2/share/farmbot_nav2/config/nav2_params.yaml"
NAV2_LAUNCH="/home/mr_robot/robot_ws/install/farmbot_nav2/share/farmbot_nav2/launch/navigation_localization_composable.launch.py"
...
sed -i "s|/home/mr_robot/data/maps/[^\"')]*\.pbstream|/home/mr_robot/data/maps/${MAP_NAME}.pbstream|g" "$LOCALIZATION_LAUNCH"

# Update YAML path in nav2_params.yaml
# sed -i "s|maps/.*\.yaml|maps/${MAP_NAME}.yaml|g" "$NAV2_PARAMS"

sed -i "s|/home/mr_robot/data/maps/[^\"')]*\.yaml|/home/mr_robot/data/maps/${MAP_NAME}.yaml|g" "$NAV2_PARAMS"
